...
const redirect = (req, res) => res.redirect(302, '/resume/docs/home');
app.get('/', redirect);
app.get('/resume/', redirect);
app.get('/resume/docs', redirect);
...
app.use('/resume', express.static(__dirname + '/build', { maxAge: '25d' }));
